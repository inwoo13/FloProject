...
class SavedSongFragment : Fragment() {
    ...
    private val itemSongAdapter = SavedSongRVAdapter(Dummy())
    ...
    override fun onCreateView(
        ...
        itemSongAdapter.setSavedSongClickListener(object: SavedSongRVAdapter.SavedSongClickListener{
            override fun onRemoveSavedSong(position: Int) {
                itemSongAdapter.removeSong(position)
            }
        })
